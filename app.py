...
# LIMPEZA DE MEMÓRIA (Obrigatório para resolver seu erro)
# Isso apaga qualquer credencial velha/errada que ficou travada
st.cache_resource.clear()
st.cache_data.clear()

# --- 2. CREDENCIAIS (JÁ EMBUTIDAS E FORMATADAS) ---
def conectar_banco():
    # Estou usando a chave 305b... que você forneceu.
    # Já converti as quebras de linha para o formato real.
...
def preparar_abas():
    ...
    try:
        ...
        **CONEXÃO BEM SUCEDIDA!** 🎉
        ...
        O erro JWT sumiu. Agora é só permissão.
