...
# --- 2. CREDENCIAIS (JÁ INSERIDAS E CORRIGIDAS) ---
def carregar_credenciais():
    # Aqui estão seus dados exatos
    credenciais = {
    ...
    # --- A CORREÇÃO MÁGICA ---
    # Isso transforma o texto "\n" em quebras de linha reais que o Google aceita
...
def conectar_banco():
    ...
    try:
        # Conecta usando o dicionário já corrigido
...
def preparar_abas():
    ...
    try:
        ...
        st.markdown(f"""
        **Sucesso! O erro de conexão sumiu.** 🎉
        
        Agora só falta a permissão final.
        
        1. Vá na planilha **banco_dados_insulina** no Google.
        2. Clique em **Compartilhar**.
        3. Cole este e-mail e marque como **EDITOR**:
        """)
